import { getCurrentInstance, version, shallowRef, computed, reactive, isReadonly, useSSRContext, createApp, toRef, isRef, nextTick, provide, onErrorCaptured, onServerPrefetch, unref, inject, defineAsyncComponent, withCtx, createVNode, defineComponent, h, Suspense, Transition } from 'vue';
...
const components = {};
const components_plugin_KfanmP5AsX = defineNuxtPlugin((nuxtApp) => {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-991f8f30.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-32861062.mjs').then((r) => r.default || r));
